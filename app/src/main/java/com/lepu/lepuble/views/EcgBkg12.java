...
public class EcgBkg12 extends View {
...
//    private int gridColor1mm = R.color.ecg_line_2;
    ...
    public EcgBkg12(Context context) {
        super(context);
        init(null, 0);
    }

    public EcgBkg12(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public EcgBkg12(Context context, AttributeSet attrs, int defStyle) {
...
//        canvas.drawPath(path, redPaint);
        ...
        // 1mm y
        for (int i = 0; i < mHeight/2/(1/EcgDataController.getMm2px()); i ++) {
            Path p = new Path();
            p.moveTo(0, mBase + i*(1/EcgDataController.getMm2px()));
            p.lineTo(mWidth, mBase + i*(1/EcgDataController.getMm2px()));
        ...
        // 5mm y
        for (int i = 0; i < mHeight/2/(5/EcgDataController.getMm2px()); i++) {
            Path p = new Path();
            p.moveTo(0, mBase + i*(5/EcgDataController.getMm2px()));
            p.lineTo(mWidth, mBase + i*(5/EcgDataController.getMm2px()));
        ...
        // 20 mm y
        for (int i = 0; i < mHeight/2/(20/EcgDataController.getMm2px()); i++) {
//            Path p = new Path();
//            p.moveTo(0, mBase + i*(20/DataController.getMm2px()));
//            p.lineTo(mWidth, mBase + i*(20/DataController.getMm2px()));
//
//            p.moveTo(0, mBase - i*(20/DataController.getMm2px()));
//            p.lineTo(mWidth, mBase - i*(20/DataController.getMm2px()));
//
//            canvas.drawPath(p, redPaint);
        ...
        // 1mm x
        for (int i = 0; i < mWidth/(1/ EcgDataController.getMm2px()) + 1; i++) {
            Path p = new Path();
            p.moveTo(i/ EcgDataController.getMm2px(), 0);
            p.lineTo(i/ EcgDataController.getMm2px(), mHeight);
            canvas.drawPath(p, bkg_paint_2);
        }

        // 5mm x
        for (int i = 0; i < mWidth/(5/ EcgDataController.getMm2px()) + 1; i++) {
            Path p = new Path();
            p.moveTo(i*5/ EcgDataController.getMm2px(), 0);
            p.lineTo(i*5/ EcgDataController.getMm2px(), mHeight);
            canvas.drawPath(p, bkg_paint_1);
        }


        // 25mm x
//        for (int i = 0; i<mWidth/(25/ DataController.getMm2px()) + 1; i++) {
//            Path p = new Path();
//            p.moveTo(i*25/ DataController.getMm2px(), 0);
//            p.lineTo(i*25/ DataController.getMm2px(), mHeight);
//            canvas.drawPath(p, redPaint);
//        }
