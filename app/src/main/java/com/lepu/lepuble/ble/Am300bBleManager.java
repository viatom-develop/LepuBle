...
public class Am300bBleManager extends BleManager {
    ...
    private Am300bBleManager.onNotifyListener listener;

    public void setNotifyListener(Am300bBleManager.onNotifyListener listener) {
        this.listener = listener;
    }

    public Am300bBleManager(@NonNull final Context context) {
        super(context);
    }
    ...
    protected BleManagerGattCallback getGattCallback() {
        return new Am300bBleManager.MyManagerGattCallback();
    }
